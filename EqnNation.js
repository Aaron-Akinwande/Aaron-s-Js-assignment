...
while (start == 1 ) {
    ...
    var choice = prompt(`Please choose a number.
    ...
    if(choice == 1){
        var num1,num2,area1,perimeter1
        num1 = Number(prompt('Input Length'))
        num2 = Number(prompt('Input Breadth'))
        area1 = eval(num1*num2)
        perimeter1 = eval(( 2*(num1+num2)))
